# -*- coding: utf-8 -*-
"""
Created on Mon Sep 18 22:26:51 2023
...
for da in datasett:
        for N in N_set:
            ...
            tick = time.time()
            a, b, yp=LBC.LBC(x_train, y_train, cost=1, t=timel, max_depth=1, N=N,alpha =0.001,f1=0.1)
            tock = time.time()
            ...
            res_sk.to_csv('reslutb1b2.csv', index=False)
